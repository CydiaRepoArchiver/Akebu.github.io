...
addView("What's new ?", "31 Dec. 2016", "- Swedish translation<br>- Fixed permissions")

var object = ["Author", "Category", "Updated","Version","Compatibility","Languages","Dependencies"];
var key = ["Tony Ciroussel","Tweaks","31 Dec. 2016","1.1 Beta","iPhone, iPad, iPod with iOS 9.0 or greater, not compatible with iOS 10", "English, Français, العربية, Nederlands, Svenska", "mobilesubstrate, sudo, sed, preferenceloader"];
